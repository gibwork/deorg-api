...
export class AddTransferEnumTransactionMigration1727019936835
  implements MigrationInterface
{
  name = 'AddTransferEnumTransactionMigration1727019936835';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('deposit', 'transfer', 'withdraw', 'refund')`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('deposit', 'withdraw', 'refund')`
    );
    await queryRunner.query(
