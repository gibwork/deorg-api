...
export class CreateExploreViewMigration1728410256763
  implements MigrationInterface
{
  name = 'CreateExploreViewMigration1728410256763';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "bounties" ADD "is_featured" boolean NOT NULL DEFAULT false`
    );
    ...
    SELECT
      ...
      ), 0)) / CAST(a.amount AS numeric) * a.price AS remaining_amount
    FROM tasks t
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "bounties" DROP COLUMN "is_featured"`);
  }
}
