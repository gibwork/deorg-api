...
export class AddBountyIsHiddenMigration1728418826816
  implements MigrationInterface
{
  name = 'AddBountyIsHiddenMigration1728418826816';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "bounties" ADD "is_hidden" boolean NOT NULL DEFAULT false`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW "explore_view"`);
    await queryRunner.query(`ALTER TABLE "bounties" DROP COLUMN "is_hidden"`);
