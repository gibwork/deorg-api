...
export class AddTransactionStatusMigration1731858661426
  implements MigrationInterface
{
  name = 'AddTransactionStatusMigration1731858661426';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('deposit', 'transfer', 'withdraw', 'withdraw-task-blinks', 'withdraw-decaf', 'refund', 'refund-teleswap-task')`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum_old" AS ENUM('deposit', 'transfer', 'withdraw', 'withdraw-task-blinks', 'withdraw-decaf', 'refund')`
    );
    await queryRunner.query(
